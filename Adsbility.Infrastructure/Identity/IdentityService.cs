...
namespace Adsbility.Infrastructure.Identity
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<ApplicationUser> userManager, IConfiguration configration, IMailService mailService, RoleManager<ApplicationRole> roleManager, IJwtHandler jwtHandler, AppilicationDbContext context )
        {
